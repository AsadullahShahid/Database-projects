...
create table date_sheet(course_name varchar(20) NOT NULL,section_name varchar(20) NOT NULL,start_time varchar (20) NOT NULL, end_time varchar (20) NOT NULL,exame_date date)
insert into date_sheet values('OOP','3B','09:00AM','5:00PM','01-10-2019')
insert into date_sheet values('DSA','2A','10:00AM','10:00PM','11-09-2019')
insert into date_sheet values('CALCULAS','3B','11:00AM','04:00PM','03-25-2019')
insert into date_sheet values('DISCRETE MATH','1B','01:00PM','03:00PM','04-17-2019')
insert into date_sheet values('JAVA','4C','10:00AM','12:00PM','07-18-2019')
insert into date_sheet values('PF','2C','12:00PM','02:00PM','01-10-2019')
...
insert into date_sheet values('MARKETING','4B','12:00PM','02:00PM','12-23-2019')
...
alter proc spAddstu1
as
begin
insert into students values(12,'Alina','Ajmal','Lahore','Alina@facebook.com','Bcsm-f17-255')
End
